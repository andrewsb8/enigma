...
func GetTerrainFromID(terrain_id string, tile *Tile) {
	...
	if int_id == 1 {
		...
		tile.Movement_cost = [8]int{1, 1, 1, 2, 100, 100, 1, 100}
	} else if int_id == 2 {
		tile.Terrain_type = "mountain"
		tile.Defense_stars = 4
		tile.Movement_cost = [8]int{2, 1, 100, 100, 100, 100, 1, 100}
	} else if int_id == 3 {
		tile.Terrain_type = "woods"
		tile.Defense_stars = 2
		tile.Movement_cost = [8]int{1, 1, 2, 3, 100, 100, 1, 100}
		...
		tile.Defense_stars = 0
		tile.Movement_cost = [8]int{1, 1, 1, 1, 100, 100, 1, 100}
	} else if int_id == 28 {
		tile.Terrain_type = "sea"
		tile.Defense_stars = 1
		tile.Movement_cost = [8]int{100, 100, 100, 100, 1, 1, 1, 100}
	} else if int_id >= 29 && int_id <= 32 {
		tile.Terrain_type = "shoals"
		tile.Defense_stars = 0
		tile.Movement_cost = [8]int{1, 1, 1, 1, 100, 1, 1, 100}
	} else if int_id == 33 {
		tile.Terrain_type = "reefs"
		tile.Defense_stars = 1
		tile.Movement_cost = [8]int{100, 100, 100, 100, 2, 2, 1, 100}
		...
		tile.Defense_stars = 0
		tile.Movement_cost = [8]int{100, 100, 100, 100, 100, 100, 100, 1}
